package org.illaydevel.sql4es.jdbc;
...
import org.illaydevel.sql4es.ESUpdateState;
...
import org.illaydevel.sql4es.parse.sql.QueryParser;
...
public class ESStatement implements Statement {
    ...
    public ResultSet executeQuery(String sql) throws SQLException {
        ...
        if (connection.getSchema() == null)
            throw new SQLException("No active index set for this driver. Pleas specify an active index or alias by executing 'USE <index/alias>' first");
    ...
    public boolean execute(String sql) throws SQLException {
        ...
        if (sqlNorm.startsWith("select") || sqlNorm.startsWith("explain")) {
            ...
            throw new SQLException("Provided query type '" + sql.substring(0, sql.indexOf(' ')) + "' is not supported");
    }
